...
public class ThriftMessage implements org.apache.thrift.TBase<ThriftMessage, ThriftMessage._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftMessage> {
  ...
  private static final _Fields optionals[] = {_Fields._RECEIVER_ID,_Fields._SUBJECT,_Fields._SEQUENCE_NO,_Fields._TOTAL_COUNT,_Fields._BINARY,_Fields._PAYLOAD,_Fields._LIST_MESSAGE,_Fields._SET_MESSAGE,_Fields._MAP_MESSAGE,_Fields._LIST_BOOL,_Fields._LIST_I16,_Fields._LIST_I32,_Fields._LIST_I64,_Fields._LIST_STRING,_Fields._SET_BOOL,_Fields._SET_I16,_Fields._SET_I32,_Fields._SET_I64,_Fields._SET_DOUBLE,_Fields._SET_STRING,_Fields._MAP_BOOL,_Fields._MAP_I16,_Fields._MAP_I32,_Fields._MAP_I64,_Fields._MAP_DOUBLE,_Fields._MAP_STRING};
  ...
  static {
    ...
    tmpMap.put(_Fields._LIST_I64, new org.apache.thrift.meta_data.FieldMetaData("_list_i64", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64))));
    tmpMap.put(_Fields._LIST_DOUBLE, new org.apache.thrift.meta_data.FieldMetaData("_list_double", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
  ...
  public ThriftMessage(
    ...
    java.util.List<java.lang.Double> _list_double)
  {
    this();
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (_list_double == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field '_list_double' was not present! Struct: " + toString());
    }
  ...
  private static class ThriftMessageTupleScheme extends org.apache.thrift.scheme.TupleScheme<ThriftMessage> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftMessage struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct._timestamp);
      {
        ...
        for (double _iter91 : struct._list_double)
        {
      ...
      if (struct.isSet_list_message()) {
        {
          ...
          for (ThriftMessage _iter92 : struct._list_message)
          {
            _iter92.write(oprot);
          }
        }
      ...
      if (struct.isSet_set_message()) {
        {
          ...
          for (ThriftMessage _iter93 : struct._set_message)
          {
            _iter93.write(oprot);
          }
        }
      ...
      if (struct.isSet_map_message()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, ThriftMessage> _iter94 : struct._map_message.entrySet())
          {
      ...
      if (struct.isSet_list_bool()) {
        {
          ...
          for (boolean _iter95 : struct._list_bool)
          {
            oprot.writeBool(_iter95);
          }
        }
      }
      if (struct.isSet_list_i16()) {
        {
          ...
          for (short _iter96 : struct._list_i16)
          {
      ...
      if (struct.isSet_list_i32()) {
        {
          ...
          for (int _iter97 : struct._list_i32)
          {
      ...
      if (struct.isSet_list_i64()) {
        {
          ...
          for (long _iter98 : struct._list_i64)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftMessage struct) throws org.apache.thrift.TException {
      ...
      struct.set_timestampIsSet(true);
      {
        org.apache.thrift.protocol.TList _list112 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
        struct._list_double = new java.util.ArrayList<java.lang.Double>(_list112.size);
        double _elem113;
        for (int _i114 = 0; _i114 < _list112.size; ++_i114)
        {
          _elem113 = iprot.readDouble();
          struct._list_double.add(_elem113);
        }
      }
      struct.set_list_doubleIsSet(true);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct._list_message = new java.util.ArrayList<ThriftMessage>(_list115.size);
          ThriftMessage _elem116;
          for (int _i117 = 0; _i117 < _list115.size; ++_i117)
          {
            _elem116 = new ThriftMessage();
            _elem116.read(iprot);
            struct._list_message.add(_elem116);
          }
        }
        struct.set_list_messageIsSet(true);
      }
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TSet _set118 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct._set_message = new java.util.HashSet<ThriftMessage>(2*_set118.size);
          ThriftMessage _elem119;
          for (int _i120 = 0; _i120 < _set118.size; ++_i120)
          {
            _elem119 = new ThriftMessage();
            _elem119.read(iprot);
            struct._set_message.add(_elem119);
          }
        }
        struct.set_set_messageIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TMap _map121 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct._map_message = new java.util.HashMap<java.lang.String,ThriftMessage>(2*_map121.size);
          java.lang.String _key122;
          ThriftMessage _val123;
          for (int _i124 = 0; _i124 < _map121.size; ++_i124)
          {
            _key122 = iprot.readString();
            _val123 = new ThriftMessage();
            _val123.read(iprot);
            struct._map_message.put(_key122, _val123);
          }
        }
        struct.set_map_messageIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct._list_bool = new java.util.ArrayList<java.lang.Boolean>(_list125.size);
          boolean _elem126;
          for (int _i127 = 0; _i127 < _list125.size; ++_i127)
          {
            _elem126 = iprot.readBool();
            struct._list_bool.add(_elem126);
          }
        }
        struct.set_list_boolIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list128 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I16, iprot.readI32());
          struct._list_i16 = new java.util.ArrayList<java.lang.Short>(_list128.size);
          short _elem129;
          for (int _i130 = 0; _i130 < _list128.size; ++_i130)
          {
            _elem129 = iprot.readI16();
            struct._list_i16.add(_elem129);
          }
        }
        struct.set_list_i16IsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct._list_i32 = new java.util.ArrayList<java.lang.Integer>(_list131.size);
          int _elem132;
          for (int _i133 = 0; _i133 < _list131.size; ++_i133)
          {
            _elem132 = iprot.readI32();
            struct._list_i32.add(_elem132);
          }
        }
        struct.set_list_i32IsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct._list_i64 = new java.util.ArrayList<java.lang.Long>(_list134.size);
          long _elem135;
          for (int _i136 = 0; _i136 < _list134.size; ++_i136)
          {
            _elem135 = iprot.readI64();
            struct._list_i64.add(_elem135);
          }
        }
        struct.set_list_i64IsSet(true);
      }
