...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<ThriftServiceHandler> handler(new ThriftServiceHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new ThriftServiceProcessor(handler));
